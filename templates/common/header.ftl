...
// 	"Jimmy John's (4302 Walnut St, Philadelphia PA 19104) **id:6**" ];
	// $.get("/cis330-gp16/autocomplete.json", function(data){
...
$(function(){
	$("#tags").keyup(function(){
		var str = $(this).val();
		if (str.length == 4){
			// alert("sending for autocomplete on " + str);
			$.getJSON("/cis330-gp16/autocomplete", {autocomplete: str}, function(data){
				// alert(data);
				console.log(data);
				// var availableTags = data;
				$( "#tags" ).autocomplete({
	...
	<div id="header">
		...
		<div id="page">
			...
			<div class="box-user">
				...
				<span class="span_log" href=""><a href="/cis330-gp16/owner">Already have a Account ? Login in</a></span>
				<span class="span_reg" href=""><a href="/cis330-gp16/signup">Register here</a></span>
